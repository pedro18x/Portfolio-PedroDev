      ...
      <div className="container mx-auto px-4 text-center">
        ...
        >
          <form className="flex flex-col gap-4">
            <input type="text" placeholder="Seu Nome" className="p-4 rounded-lg bg-gray-200/80 dark:bg-gray-800/80 border-transparent focus:ring-primary focus:border-primary"/>
            <input type="email" placeholder="Seu E-mail" className="p-4 rounded-lg bg-gray-200/80 dark:bg-gray-800/80 border-transparent focus:ring-primary focus:border-primary"/>
            <textarea placeholder="Sua Mensagem" rows={5} className="p-4 rounded-lg bg-gray-200/80 dark:bg-gray-800/80 border-transparent focus:ring-primary focus:border-primary"></textarea>
