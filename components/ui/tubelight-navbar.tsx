  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center gap-3 bg-background/5 border border-border backdrop-blur-lg py-1 px-1 rounded-full shadow-lg mb-6 sm:mb-0 sm:mt-6 pointer-events-auto"
      >
        {items.map((item) => {
